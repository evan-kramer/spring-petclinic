...
# docker run -d --name sonarqube -e SONAR_ES_BOOTSTRAP_CHECKS_DISABLE=true -e SONAR_LOGIN=sqa_b52742766a1a527fc924e47305f9f79ea5f20b63 -p 9000:9000 --network 17646-assignment1 sonarqube:latest
