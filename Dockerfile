...
# docker run -d --name sonarqube -e SONAR_ES_BOOTSTRAP_CHECKS_DISABLE=true -e SONAR_LOGIN={$SONAR_LOGIN} -p 9000:9000 --network 17646-assignment1 --platform linux/amd64 sonarqube:latest
